...
public sealed class PracticeSession { public Guid Id { get; set; } = Guid.NewGuid(); public Guid UserId { get; set; } public string ActorId { get; set; } = ""; public string ScenarioId { get; set; } = ""; public int DirectnessLevel { get; set; } = 3; public string Status { get; set; } = "active"; public string PromptVersion { get; set; } = "roleplay-v1"; public DateTimeOffset StartedAt { get; set; } = DateTimeOffset.UtcNow; public DateTimeOffset? CompletedAt { get; set; } public AppUser User { get; set; } = null!; public Actor Actor { get; set; } = null!; public Scenario Scenario { get; set; } = null!; public List<ChatMessage> Messages { get; set; } = []; public SessionEvaluation? Evaluation { get; set; } public List<QuizAttempt> QuizAttempts { get; set; } = []; }
...
public sealed class QuizAttempt { public Guid Id { get; set; } = Guid.NewGuid(); public Guid UserId { get; set; } public Guid SessionId { get; set; } public string QuestionsJson { get; set; } = "[]"; public string AnswersJson { get; set; } = "[]"; public int Score { get; set; } public int MaxScore { get; set; } public int ConfidenceBefore { get; set; } public int ConfidenceAfter { get; set; } public DateTimeOffset CreatedAt { get; set; } = DateTimeOffset.UtcNow; public AppUser User { get; set; } = null!; public PracticeSession Session { get; set; } = null!; }
